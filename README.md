...
```r
clquestions::fetch_raw_query(url)
```

Takes a URL for the written question or written statement endpoints, retrieves and converts data into a tibble, and standardises variable names. No further cleaning or alteration of the data occurs. 
